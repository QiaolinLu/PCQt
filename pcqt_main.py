...
class Peter_Clark_Test(QWidget):
    ...
    def initUI(self):
        ...
        self.indepedence_test_method = QLabel("独立性检验: ")
        ...
        self.mvpc_label = QLabel("缺失值选择：")
        layout.addWidget(self.mvpc_label)
        self.mvpc = QComboBox()
